...
rotating checkpoint keeps at most three generations plus up to 16 h of
compact sub-hour points (enough for the widest graph and its clock-alignment
margin). The supplied systemd timer starts a short-lived process each minute
